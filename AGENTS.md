...
- Keep this module generic and reusable; do not add module-specific gameplay logic that belongs in `thermal` or `survive`.
...
- `ModAttachments.kt` defines trait attachment types; when changing base attachments, ensure registration is correctly wired to mod bus.
